...
import { getUpComingReunion } from "../../utils/api";
...
const Topbar = () => {
  ...
  const handleToggleNotifications = async (event) => {
    ...
    if (!showNotifications) {
      setLoading(true);
      try {
        const response = await getUpComingReunion(authTokens?.accessToken,user.id);
                ...
                <>
                  {user.role === 'STAGIAIRE' && (
                    <ListItem>
                      ...
                      <ListItemText primary={user.institution} />
                    </ListItem>
                  )}
                  ...
                  {user.role === 'TUTEUR' && (
                    <ListItem>
                      ...
                      <ListItemText primary={user.entreprise} />
                    </ListItem>
                  )}
                </>
              </List>
