...
const DistributionStagiairesInstitution = ({ isDashboard = false }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const distribution = response.repartitionStagiairesParInstitution || {};
...
export default DistributionStagiairesInstitution;
